...
*/
var carro = {marca: "Fiat", modelo: "Uno", placa: "AAA000", ano: 2015, cor: "Preto", quantasPortas: 4, assentos: 5, quantidadePessoas: 0};
...
*/
carro.addPessoa = function(qt){
	if (carro.quantidadePessoas === carro.assentos) { return "O carro já está lotado!";}
	if (carro.quantidadePessoas + qt > carro.assentos) { var p = carro.assentos - carro.quantidadePessoas === 1; return "Só " + (p ? "cabe" : "cabem") + " mais " + (carro.assentos - carro.quantidadePessoas) + (p ? " pessoa!" : " pessoas!");}
	
	carro.quantidadePessoas += qt;
