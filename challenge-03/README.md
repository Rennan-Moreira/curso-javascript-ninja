...
*/
var pessoa = {nome: "Rennan", sobrenome: "Moreira", sexo: "Masculino", idade: 21, altura: 1.75, peso: 69, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.andar = function(m) {pessoa.caminhouQuantosMetros += m; pessoa.andando = true;};
...
*/
pessoa.nomeCompleto(); //"Olá! Meu nome é Rennan Moreira!"
...
*/
pessoa.andar(2) + pessoa.andar(4) + pessoa.andar(10);
...
*/
pessoa.caminhouQuantosMetros; //42
...
return "Olá, eu sou " + sexo + " " + pessoa.nome + " " + pessoa.sobrenome + ", tenho " + pessoa.idade + " " + ano + ", " + pessoa.altura + "m de altura, meu peso é " + pessoa.peso + "kg e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + " " + metro + "!";};

// Agora, apresente-se ;)
pessoa.apresentacao(); //"Olá, eu sou o Rennan Moreira, tenho 31 anos, 1.75m de altura, meu peso é 69kg e, só hoje, eu já caminhei 42 metros!"
```
